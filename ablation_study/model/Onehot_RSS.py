...
class RNASeqClassifier(nn.Module):
    ...
    def forward(self, x1, _, x3):
        ...
        x1, x3 = x1.permute(0, 2, 1), x3.permute(0, 2, 1)

        identity1, identity3 = x1, x3

        # Pass x1 x3 through attention layers 
        ...
        # Average pooling for x1 x3 
        x1 = torch.mean(x1, dim=1)  
        x3 = torch.mean(x3, dim=1)  

        # Concatenate x1, x3 along the second dimension
